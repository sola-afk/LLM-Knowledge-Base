...
| **Kate Fullen** | CF4 | Trevor Gardiner | Prescribed script pathway *(moved 2026-08-28 from "No MCC Registration" per Compliance)*. Predominantly on partner/EOR provider calls (Oyster, Deel, Niural, Rise, Payfit) — **script coverage for partner-facing provider-quote calls to be confirmed** |
| **Abbi** | (role to be confirmed) | Trevor Gardiner | Prescribed script pathway *(added 2026-08-28 per Compliance)*. Appears on CS/onboarding calls (Tines, Fractile, Nutritics, Finster, Wayflyer, LearnUpon, Stripe) — **surname and role to be confirmed for register completeness** |
...
- **Concentration risk**: Trevor is sole CF7 for 14+ MCC-regulated staff (Kate Fullen and Abbi added to his span of supervision 2026-08-28).
...
2. ~~**Kate Fullen**: CF4 with no MCC registration — must cease regulated activity or obtain qualification~~ — **RESOLVED 2026-08-28**: moved to the prescribed-script pathway under Trevor Gardiner. Note this does not make her qualified; the script carve-out (run-spec Step 3.5) now applies to her scripted factual delivery, and anything beyond it remains HF-00.
