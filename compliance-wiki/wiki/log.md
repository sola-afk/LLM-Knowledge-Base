...
## [2026-09-15] monitoring | Email monitoring — Intercom — 29 Aug to 15 Sep 2026 (catch-up)
- Third run. Catch-up covering 18 days rather than a week: weeks 36 and 37 had no contemporaneous review, week 38 partial. Coverage gap noted as a limitation in its own right.
- Population: 1,484 email conversations, full sweep (10 pages, reconciled against Intercom's count). Weekly run-rate ~580, consistent with W35's 594.
- Created: output/intercom-email-monitoring-2026-W36-38.md. 3 threads assessed and added to the Email Monitoring Asana with Link and Grade populated; report posted as a red project status update.
- FOLLOW-UP ON PRIOR ESCALATIONS. Ctrl Alt (W34): behaviour changed - the same auto-enrolment topic recurred via Paligo on 14 Sep and was handled correctly, routed with no interpretation offered. Ramp (W35): correctly overturned on evidence - the PDF was checked, the individual was named only as an account admin and not as an insured member, closed with a recorded rationale. Diarmuid Egan (W35): fixed on 2 Sep, roughly 40 working hours after the flag.
- ESCALATION 1 (CPC): the pension transfer failure RECURRED. Marje Cruz wrote 8 Sep supplying what Kota had asked for; no reply in 7 days, both SLA targets breached, still open. Same subtopic, team and assignee as the W35 case. The individual case was fixed without the cause being fixed. The W35 recommendation on Fin escalating queries it holds approved content for (art. 9145103) has not been actioned.
- ESCALATION 2 (Data Protection / CPC): Deel flagged a confirmed residence-country discrepancy affecting which country plan a member is on. No reply sent; tagged "BenOps - Deel - Bad Ticket" and closed 87 minutes later over a ticket-routing complaint. Left unassessed: a confirmed inaccurate record, and whether the member's cover responds where she actually lives. Five "Personal Data Correction" requests arrived this period, all on Embed P0, all SLA-missed, with no visible handling standard and no evidence they are treated as Article 16 rectification requests.
- SLA: Urgent tier has effectively stopped functioning - 30 of 32 missed the 30-minute target, degrading 74% to 80% to 94% across the three periods. Embed P0 75% (was 69%), BenOps P1 64% (was 52%), P3 SME 24% (improved). Overall 56%, flat. Misrouting improved to 18%.
- Live deadline: Paligo chasing on an employee facing double pension deductions with a payroll cut-off this week. Also re-surfaces the unresolved W34 question on whether the EUR 20,000 AE threshold is per-employment or aggregate.
- Carried over three periods running: opt-out consequences-of-cancellation disclosure question (third Flatpay opt-out landed 2 Sep), and the missing regulatory footer on CX Platform outbound.
